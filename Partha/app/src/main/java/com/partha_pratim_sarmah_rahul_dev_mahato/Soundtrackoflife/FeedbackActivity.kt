...
import com.partha_pratim_sarmah_rahul_dev_mahato.Soundtrackoflife.databinding.ActivityFeedbackBinding
import java.util.*
import javax.mail.*
...
class FeedbackActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "প্ৰতিক্ৰিয়া"
        binding.sendFA.setOnClickListener {
            ...
            val userName = "movir11robot@gmail.com"
            val pass = "moviR11@#12"
            ...
            else Toast.makeText(this, "কিবা ভুল হৈছিল!!", Toast.LENGTH_SHORT).show()
        }
    }
}